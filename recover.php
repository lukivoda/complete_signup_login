						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-12">
									...
									<form id="recover-form"  method="post" role="form" autocomplete="off">
										...
										<div class="form-group">
											<div class="row">
												...
												<div class="col-lg-6 col-sm-6 col-xs-6">
													<input type="reset" name="cancel-submit" id="cancel-submit" tabindex="2" class="form-control btn btn-danger" value="Reset" />
												</div>
												<div class="col-lg-6 col-sm-6 col-xs-6">
										...
										<input type="hidden" class="hide" name="token" id="token" value="<?=$user->token_generator()?>">
									</form>
								</div>
							</div>
						</div>
